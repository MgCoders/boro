...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHostView.setText("http://jengit.correo.com.uy:7890");

        mUserView = (AutoCompleteTextView) findViewById(R.id.user);
        populateUserAutoComplete();
        mUserView.setText("raulsperoni@correo.com.uy");
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(host, user, password);
    ...
    private boolean isHostValid(String email) {
        //TODO: Replace this with your own logic
        return email.contains("@");
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String host, String user, String password) {
            mUser = user;
            mPassword = password;
            mHost = host;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                client.login(mHost, mUser, mPassword);
                return true;
            } catch (BoroException e) {
                Log.v("LOGIN", e.getLocalizedMessage(), e);
                return false;
            }
